...
//
//        for (int startIndex = 0; startIndex < cveCount; startIndex += Constants.NVD_MAX_PAGE_SIZE) {
//
//
//            NVDRequest request = NVDRequestFactory.createNVDRequest(HTTPMethod.GET, Constants.NVD_CVE_URI, apiKey, startIndex, Constants.NVD_MAX_PAGE_SIZE);
...
//                    HTTPMethod.GET, Utils.NVD_BASE_URI, apiKey, startIndex, Utils.NVD_MAX_PAGE_SIZE, lastModStartDate, lastModEndDate
//            );
